 ...
 *   __HAC_AVL_FIRST_POSTORDER()
 *   __HAC_AVL_NEXT_POSTORDER()
 */
#include <stdio.h>
#include "hac_avl.h"
...
int main(void){
	...
	for(__HAC_AVL_NODE_T(int) *it = __HAC_AVL_FIRST_POSTORDER(int, n); it; it = __HAC_AVL_NEXT_POSTORDER(int, it)){
		printf("%i,", it->v);
	}
	puts("");
}
