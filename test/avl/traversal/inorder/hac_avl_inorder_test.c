 ...
 *   __HAC_AVL_FIRST_INORDER()
 *   __HAC_AVL_NEXT_INORDER()
 */
#include <stdio.h>
#include "hac_avl.h"
...
int main(void){
	...
	for(__HAC_AVL_NODE_T(int) *it = __HAC_AVL_FIRST_INORDER(int, n); it; it = __HAC_AVL_NEXT_INORDER(int, it)){
		printf("%i,", it->v);
	}
	puts("");
}
